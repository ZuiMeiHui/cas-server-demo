...
public final class CasEmbeddedContainerUtils {
	...
	/**
	 * Property to dictate to the environment whether embedded container is running
	 * CAS.
	 */
	...
	public static Banner getCasBannerInstance() {
		...
		final Reflections reflections = new Reflections(
				new ConfigurationBuilder().filterInputsBy(new FilterBuilder().includePackage(packageName))
						.setUrls(ClasspathHelper.forPackage(packageName)).setScanners(new SubTypesScanner(true)));
